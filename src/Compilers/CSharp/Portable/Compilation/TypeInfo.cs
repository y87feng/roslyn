...
namespace Microsoft.CodeAnalysis.CSharp
{
    ...
    {
        internal static readonly CSharpTypeInfo None = new CSharpTypeInfo(null, null, Nullability.NotApplicable, Nullability.NotApplicable, Conversion.Identity);
        ...
        public readonly Nullability ConvertedNullability;
        ...
        internal CSharpTypeInfo(TypeSymbol type, TypeSymbol convertedType, Nullability nullability, Nullability convertedNullability, Conversion implicitConversion)
        {
        ...
        public bool Equals(CSharpTypeInfo other)
        {
            return this.ImplicitConversion.Equals(other.ImplicitConversion)
                ...
                && this.ConvertedNullability == other.ConvertedNullability;
        }
